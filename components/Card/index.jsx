      ...
      >
        ...
        <div className="flex h-full lg:mt-2 sm:gap-8 lg:gap-12 flex-col sm:flex-row">
          <div className="w-full sm:w-3/5 relative top-10">
            <p className="text-center lg:text-lg sm:text-lg leading-7 first-letter:text-xl font-bold" style={{ fontFamily: 'Source Sans 3, sans-serif', fontWeight: 95, lineHeight: '1.2'}}>
            {t(description)}
            </p>
            ...
            <Link
              ...
              <p className="lg:text-md text-black text-center" style={{ fontFamily: 'Source Sans 3, sans-serif', fontWeight: 90, lineHeight: '1.2'}}>{localDate}</p>
            </span>
          </div>
